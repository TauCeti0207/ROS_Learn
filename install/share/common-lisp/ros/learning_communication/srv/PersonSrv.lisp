...
(cl:defmethod cl:initialize-instance :after ((m <PersonSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PersonSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learning_communication-srv:<PersonSrv-request> is deprecated: use learning_communication-srv:PersonSrv-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <PersonSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_communication-srv:name-val is deprecated.  Use learning_communication-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <PersonSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_communication-srv:age-val is deprecated.  Use learning_communication-srv:age instead.")
  (age m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <PersonSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_communication-srv:sex-val is deprecated.  Use learning_communication-srv:sex instead.")
  (sex m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PersonSrv-request>)))
  ...
  "learning_communication/PersonSrvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PersonSrv-request)))
  "Returns string type for a service object of type 'PersonSrv-request"
  "learning_communication/PersonSrvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <PersonSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PersonSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learning_communication-srv:<PersonSrv-response> is deprecated: use learning_communication-srv:PersonSrv-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <PersonSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_communication-srv:result-val is deprecated.  Use learning_communication-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PersonSrv-response>)))
  ...
  "learning_communication/PersonSrvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PersonSrv-response)))
  "Returns string type for a service object of type 'PersonSrv-response"
  "learning_communication/PersonSrvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PersonSrv)))
  ...
  "learning_communication/PersonSrv")