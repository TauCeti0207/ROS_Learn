...
(cl:defmethod cl:initialize-instance :after ((m <PersonMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PersonMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learning_communication-msg:<PersonMsg> is deprecated: use learning_communication-msg:PersonMsg instead.")))
