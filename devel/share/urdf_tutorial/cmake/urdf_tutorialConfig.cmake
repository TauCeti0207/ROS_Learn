...
if("TRUE" STREQUAL "TRUE")
  set(urdf_tutorial_SOURCE_PREFIX /home/yzq0207/catkin_ws/src/urdf_tutorial)
  set(urdf_tutorial_DEVEL_PREFIX /home/yzq0207/catkin_ws/devel)
  ...
  set(urdf_tutorial_INSTALL_PREFIX /home/yzq0207/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yzq0207/catkin_ws/src/urdf_tutorial/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(urdf_tutorial_EXPORTED_TARGETS ${${urdf_tutorial_dep}_EXPORTED_TARGETS})
endforeach()
