...
let KeyFrameHandleGoal = require('./KeyFrameHandleGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class KeyFrameHandleActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new KeyFrameHandleGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = KeyFrameHandleGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new KeyFrameHandleActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = KeyFrameHandleGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new KeyFrameHandleActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = KeyFrameHandleGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new KeyFrameHandleGoal()
    }
...
module.exports = KeyFrameHandleActionGoal;
