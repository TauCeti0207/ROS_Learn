...
let KeyFrameHandleFeedback = require('./KeyFrameHandleFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class KeyFrameHandleActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new KeyFrameHandleFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = KeyFrameHandleFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new KeyFrameHandleActionFeedback(null);
    ...
    data.feedback = KeyFrameHandleFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new KeyFrameHandleActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = KeyFrameHandleFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new KeyFrameHandleFeedback()
    }
...
module.exports = KeyFrameHandleActionFeedback;
